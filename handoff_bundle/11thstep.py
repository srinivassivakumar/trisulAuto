...
RULE_FILE = str(WORKSPACE / "network_issue_rules.json")
DEFAULT_VM_JSON = str(WORKSPACE / "vm_data.json")
DEFAULT_RAM_JSON = str(WORKSPACE / "ram_resources.json")
DEFAULT_CPU_JSON = str(WORKSPACE / "CPU_resources.json")
    ...
    if check_trisul_connection(TRISUL_HOST, TRISUL_PORT):
        try:
            if args.mode == "serve_api":
                ...
                html_output = str(WORKSPACE / "tcp-report.html")
