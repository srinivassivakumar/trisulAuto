...
""")
    ...
    <div class="infra-section">
        ...
        <div class="infra-grid">
            <div class="infra-item"><span class="infra-label">Hostname:</span>{escape(str(vm_info.get("hostname", "-")))}</div>
            <div class="infra-item"><span class="infra-label">LAN IP:</span>{escape(str(vm_info.get("lan_ip", "-")))}</div>
            <div class="infra-item"><span class="infra-label">WAN IP:</span>{escape(str(vm_info.get("wan_ip", "-")))}</div>
            ...
            <div class="infra-item"><span class="infra-label">Total RAM:</span>{escape(f"{_to_float(ram_info.get('total_gb', 0.0)):.2f} GB")}</div>
            <div class="infra-item"><span class="infra-label">Disk:</span>{escape(str(vm_info.get("disk", "-")))}</div>
            <div class="infra-item"><span class="infra-label">Power Status:</span>{escape(str(vm_info.get("power_status", "-")))}</div>
        </div>
    </div>
""")
